...
(function (factory) {
    ...
    function Autocomplete2(el, options) {
        ...
        that.options = $.extend(true, {}, Autocomplete2.defaults, options);
        that.classes = {
    ...
    $.fn.devbridgeAutocomplete2 = function (options, args) {
    ...
    if (!$.fn.autocomplete2) {
        $.fn.autocomplete2 = $.fn.devbridgeAutocomplete2;
    }
}));